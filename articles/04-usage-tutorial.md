...
- **Anthropic Claude 3.7 Sonnet** (`claude-3-7-sonnet-20250219`):
  Excellent biological knowledge, best for discussion
- **OpenAI GPT-4o** (`gpt-4o`): Strong overall performance, good
  biological knowledge
- **Google Gemini 1.5 Pro** (`gemini-1.5-pro`): Good performance with
  detailed reasoning
...
- **Anthropic Claude 3.5 Sonnet** (`claude-3-5-sonnet-20240620`): Good
...
- **Microsoft MAI-DS-R1** (`microsoft/mai-ds-r1:free`): Reliable with
  good response time
- **DeepSeek Chat v3** (`deepseek/deepseek-chat-v3-0324:free`): Free
  model with 163K context window (may occasionally return empty results)
...
- `deepseek/deepseek-chat-v3-0324:free`: May occasionally return empty
  results
...
If you see “non-character parameter” (non-character parameter) errors:

- This typically occurs when using non-English language models like
  `thudm/glm-z1-9b:free` for consensus checking
- Switch to an English model like `meta-llama/llama-4-maverick:free` for
  consensus checking
...
- Some models like `deepseek/deepseek-chat-v3-0324:free` may
  occasionally return empty results
