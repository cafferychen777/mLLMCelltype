# Preprocessing script for GTEx skin cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/GTEx_skin_markers.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/GTEx_skin_markers.rds"))

print("\nPreprocessing complete. Data saved to GTEx_skin_markers.rds")
