...
raw_data <- readLines(file.path(project_root, "data/reference/lung_v2_markers_L2.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/lung_markers.rds"))

print("\nPreprocessing complete. Data saved to lung_markers.rds")
