...
raw_data <- readLines(file.path(project_root, "data/reference/heart_markers_L1.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/heart_markers.rds"))

print("\nPreprocessing complete. Data saved to heart_markers.rds")
