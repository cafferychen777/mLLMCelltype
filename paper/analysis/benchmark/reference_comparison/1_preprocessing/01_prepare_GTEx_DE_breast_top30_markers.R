# Preprocessing script for breast cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/GTEx_DE_breast_top30_markers.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/GTEx_DE_breast_top30_markers.rds"))

print("\nPreprocessing complete. Data saved to GTEx_DE_breast_top30_markers.rds")
