# Preprocessing script for GTEx esophagus cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/GTEx_esophagus_markers.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/GTEx_esophagus_markers.rds"))

print("\nPreprocessing complete. Data saved to GTEx_esophagus_markers.rds")
