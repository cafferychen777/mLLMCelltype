# Preprocessing script for kidney cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/kidney_markers_L1.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/kidney_markers.rds"))

print("\nPreprocessing complete. Data saved to kidney_markers.rds")
