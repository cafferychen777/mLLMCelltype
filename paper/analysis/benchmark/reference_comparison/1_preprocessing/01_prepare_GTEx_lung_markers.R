# Preprocessing script for GTEx lung cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/GTEx_lung_markers.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/GTEx_lung_markers.rds"))

print("\nPreprocessing complete. Data saved to GTEx_lung_markers.rds")
