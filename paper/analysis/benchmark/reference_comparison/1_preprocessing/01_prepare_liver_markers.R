# Preprocessing script for liver cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/liver_markers_L2.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/liver_markers.rds"))

print("\nPreprocessing complete. Data saved to liver_markers.rds")
