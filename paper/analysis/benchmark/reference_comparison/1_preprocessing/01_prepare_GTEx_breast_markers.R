...
raw_data <- readLines(file.path(project_root, "data/reference/GTEx_breast_markers.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/GTEx_breast_markers.rds"))

print("\nPreprocessing complete. Data saved to GTEx_breast_markers.rds")
