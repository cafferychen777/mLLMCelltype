# Preprocessing script for motor cortex cell type benchmark
library(dplyr)
library(tidyr)
library(readr)
...
raw_data <- readLines(file.path(project_root, "data/reference/motor_cortex_markers_subclass.csv"))
...
saveRDS(markers_list, file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/motor_cortex_markers.rds"))

print("\nPreprocessing complete. Data saved to motor_cortex_markers.rds")
