...
unlink(file.path(project_root, "results/benchmark/popv_comparison/2_evaluation/HLCA_leiden_2_results.rds"))
...
markers_list <- readRDS(file.path(project_root, "results/benchmark/popv_comparison/1_preprocessing/HLCA_leiden_2_markers.rds"))
    ...
    tryCatch({
      ...
      saveRDS(results,
              file.path(project_root,
                        sprintf("results/benchmark/popv_comparison/2_evaluation/HLCA_leiden_2_results_part%d.rds", i)))

      print(sprintf("Part %d evaluation complete. Results saved to HLCA_leiden_2_results_part%d.rds", i, i))
...
# Save merged results
combined_file <- file.path(project_root, "results/benchmark/reference_comparison/2_evaluation/HLCA_leiden_2_results.rds")
