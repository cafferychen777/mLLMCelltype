# Evaluation script for GTEx Skin cell type benchmark
library(LLMCellType)
...
unlink(file.path(project_root, "results/benchmark/reference_comparison/2_evaluation/GTEx_skin_results.rds"))
...
markers_list <- readRDS(file.path(project_root, "results/benchmark/reference_comparison/1_preprocessing/GTEx_skin_markers.rds"))
...
for (i in 1:num_parts) {
  ...
  saveRDS(results,
          file.path(project_root,
                    sprintf("results/benchmark/reference_comparison/2_evaluation/GTEx_skin_results_part%d.rds", i)))

  print(sprintf("Part %d evaluation complete. Results saved to GTEx_skin_results_part%d.rds", i, i))
}
...
# Save merged results
combined_file <- file.path(project_root, "results/benchmark/reference_comparison/2_evaluation/GTEx_skin_results.rds")
