...
def process_minimax(prompt: str, model: str, api_key: str, group_id: str = None) -> List[str]:
    ...
    Args:
        ...
        model: The model name (e.g., 'abab5.5-chat', 'abab6-chat')
        ...
        for attempt in range(max_retries):
            try:
                ...
                if response.status_code != 200:
                    ...
                    write_log(f"ERROR: MiniMax API request failed: {error_message.get('error', {}).get('message', 'Unknown error')}")
